...
response:any;
  ...
  public chartColors: Array<any> = [
    {
      backgroundColor: [ 'rgba(16, 23, 173, 0.8)',  'rgba(16, 23, 173, 0.5)'],
      hoverBackgroundColor: [ 'rgba(16, 23, 173, 0.8)',  'rgba(16, 23, 173, 0.5)'],
      borderWidth: 2,
    }
  ];
  ...
  public perColors: Array<any> = [
    {
      backgroundColor: 'rgba(16, 23, 173, 0.5)',
      borderColor: 'rgba(16, 23, 173, 1);',
            borderWidth: 2,
    },
